...
func (mi MouseInput) ToInput() Input {
	...
	input.Bytes[24] = byte(extraInfo >> 32)
	input.Bytes[25] = byte(extraInfo >> 40)
	input.Bytes[26] = byte(extraInfo >> 48)
	input.Bytes[27] = byte(extraInfo >> 56)
	return input
}
...
func (ki KeybdInput) ToInput() Input {
	...
	input.Bytes[16] = byte(extraInfo >> 32)
	input.Bytes[17] = byte(extraInfo >> 40)
	input.Bytes[18] = byte(extraInfo >> 48)
	input.Bytes[19] = byte(extraInfo >> 56)
	return input
}
